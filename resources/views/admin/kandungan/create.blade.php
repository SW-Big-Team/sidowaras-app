            ...
            <div class="card border-0 shadow-lg rounded-3">
                <div class="card-header bg-gradient-dark p-4 rounded-top-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-0 text-white fw-bold">Tambah Kandungan Obat</h5>
                            <p class="text-sm text-white opacity-8 mb-0">Isi form berikut untuk menambahkan kandungan obat baru</p>
                        </div>
                    </div>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('admin.kandungan.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <small class="text-xs text-muted mt-1 d-block">Pisahkan dengan koma jika lebih dari satu (misal: Paracetamol, Caffeine)</small>
                        </div>
