...
@extends($layoutPath)
@section('title', 'Tambah Kandungan Obat')
        ...
        <div class="welcome-banner">
            <div class="welcome-content">
                <div class="welcome-text">
                    <span class="greeting-badge"><i class="material-symbols-rounded">science</i> Kandungan Baru</span>
                    <h2 class="welcome-title">Tambah Kandungan Obat</h2>
                    <p class="welcome-subtitle">Lengkapi form berikut untuk menambahkan kandungan obat baru ke sistem.</p>
                </div>
        ...
        <div class="card pro-card">
            <div class="card-header pro-card-header">
                <div class="header-left">
                    <div class="header-icon info"><i class="material-symbols-rounded">edit_note</i></div>
                    <div><h6 class="header-title">Form Kandungan</h6><p class="header-subtitle">Isi data kandungan obat</p></div>
                </div>
            </div>
                ...
                <form action="{{ route('admin.kandungan.store') }}" method="POST">
                    ...
                    <div class="form-section">
                        <div class="section-header">
                            <div class="section-icon info"><i class="material-symbols-rounded">science</i></div>
                            <div><h6 class="section-title">Informasi Kandungan</h6><p class="section-subtitle">Detail kandungan yang akan dibuat</p></div>
                        </div>
                                ...
                                <div class="form-group-modern">
                                    ...
                                    <div class="input-modern">
                                        ...
                                        <input type="text" name="nama_kandungan" id="nama_kandungan" 
                                               ...
                                               placeholder="Contoh: Paracetamol" value="{{ old('nama_kandungan') }}" required>
                                    </div>
                                ...
                                <div class="form-group-modern">
                                    ...
                                    <div class="input-modern">
                                        ...
                                        <input type="text" name="dosis_kandungan" 
                                               ...
                                               placeholder="Contoh: 500mg" value="{{ old('dosis_kandungan') }}" required>
                                    </div>
                    ...
                    <div class="form-actions">
                        ...
                        <button type="submit" class="btn-pro info"><i class="material-symbols-rounded">save</i> Simpan Kandungan</button>
                    </div>
                </form>
            </div>
        </div>
...
.header-icon.info { background: linear-gradient(135deg, #3b82f6, #1d4ed8); }
...
.section-icon.info { background: rgba(59,130,246,0.12); }
.section-icon.info i { color: var(--info); }
