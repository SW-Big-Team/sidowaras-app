...
@section('breadcrumb')
    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
        ...
        <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="{{ route('admin.obat.index') }}">Data
                Obat</a></li>
...
@section('content')
        ...
        <form action="{{ route('admin.obat.update', $obat->id) }}" method="POST" id="formObat">
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <div>
                        ...
                        <p class="section-subtitle">Data utama identitas obat</p>
                    </div>
                </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="form-group-modern">
                                ...
                                <div class="input-modern"><i
                                        class="material-symbols-rounded input-icon">medication</i><input type="text"
                                        name="nama_obat" class="form-control"
                        ...
                        <div class="col-md-3">
                            <div class="form-group-modern">
                                ...
                                <div class="input-modern"><i class="material-symbols-rounded input-icon">tag</i><input
                                        type="text" name="kode_obat" class="form-control"
                                        value="{{ old('kode_obat', $obat->kode_obat) }}" placeholder="Kode unik"></div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group-modern">
                                <label class="form-label-modern">Stok Minimum</label>
                                <div class="input-modern"><i class="material-symbols-rounded input-icon">warning</i><input
                                        type="number" name="stok_minimum" class="form-control"
                                        value="{{ old('stok_minimum', $obat->stok_minimum) }}" min="0" placeholder="10">
                                </div>
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <div>
                        <h6 class="section-title">Klasifikasi & Lokasi</h6>
                        <p class="section-subtitle">Kategori, satuan, dan penempatan obat</p>
                    </div>
                </div>
                <div class="section-body">
                    <div class="row g-3">
                            ...
                            <div class="form-group-modern">
                                ...
                                <div class="input-modern select">
                                    ...
                                    <select name="kategori_id" class="form-control" required>
                                        ...
                                        @foreach($kategori as $k)<option value="{{ $k->id }}" {{ old('kategori_id', $obat->kategori_id) == $k->id ? 'selected' : '' }}>{{ $k->nama_kategori }}
                                        </option>@endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group-modern">
                                ...
                                <div class="input-modern"><i
                                        class="material-symbols-rounded input-icon">location_on</i><input type="text"
                                        name="lokasi_rak" class="form-control"
                                        value="{{ old('lokasi_rak', $obat->lokasi_rak) }}" maxlength="50"
                                        placeholder="Contoh: A-01"></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="form-section">
                <div class="section-header">
                    ...
                    <div>
                        <h6 class="section-title">Komposisi & Identifikasi</h6>
                        <p class="section-subtitle">Kandungan, barcode, dan deskripsi obat</p>
                    </div>
                </div>
                <div class="section-body">
                    <div class="row g-3">
                        <div class="col-md-8">
                            <div class="form-group-modern">
                                <label class="form-label-modern">Kandungan Obat <small
                                        class="text-secondary text-lowercase fw-normal">(bisa pilih lebih dari
                                        satu)</small></label>
                                @php
                                ...
                                <select name="kandungan_id[]" id="kandunganSelectEdit" class="form-control" multiple>
                                    @foreach($kandungan as $k)<option value="{{ $k->id }}" {{ in_array($k->id, old('kandungan_id', $selectedKandungan ?? [])) ? 'selected' : '' }}>
                            ...
                            <div class="form-group-modern">
                                ...
                                <div class="input-modern barcode">
                                    ...
                                    <input type="text" name="barcode" id="barcodeInput" class="form-control"
                                        value="{{ old('barcode', $obat->barcode) }}" maxlength="100"
                                        placeholder="Scan atau ketik">
                                    <button class="btn-scan" type="button" id="btnOpenQr" aria-label="Scan"><i
                                            class="material-symbols-rounded">qr_code_scanner</i></button>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group-modern">
                                ...
                                <div class="input-modern textarea"><i
                                        class="material-symbols-rounded input-icon">description</i><textarea
                                        name="deskripsi" class="form-control" rows="3"
                                        placeholder="Deskripsi obat, indikasi, atau keterangan">{{ old('deskripsi', $obat->deskripsi) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-actions">
                <a href="{{ route('admin.obat.index') }}" class="btn-outline-pro"><i
                        class="material-symbols-rounded">arrow_back</i> Kembali</a>
                <button type="submit" class="btn-pro warning"><i class="material-symbols-rounded">update</i> Update Data
                    Obat</button>
            </div>
        </form>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content pro-modal warning">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="scan-info mt-3"><i class="material-symbols-rounded">info</i><span>Izinkan akses kamera dan
                            arahkan ke QR / Barcode yang ingin dipindai.</span></div>
                </div>
                <div class="modal-footer"><button type="button" class="btn-outline-pro" data-bs-dismiss="modal"><i
                            class="material-symbols-rounded">close</i> Tutup</button></div>
            </div>
        </div>
    </div>
    ...
    @push('styles')
        ...
        <style>
            ...
            .input-modern.textarea .input-icon {
                top: 18px;
            }
            ...
            .input-modern textarea.form-control {
                height: auto;
                padding-top: 12px;
            }
            ...
            .input-modern.select select {
                appearance: none;
                cursor: pointer;
            }

            .input-modern.barcode .form-control {
                padding-right: 50px;
            }
            ...
            .pro-modal.warning .modal-header {
                background: linear-gradient(135deg, #f59e0b, #d97706);
            }
            ...
            .input-modern .select2-container--default .select2-selection--multiple {
