            ...
            <div class="card border-0 shadow-lg rounded-3">
                <div class="card-header bg-gradient-dark p-4 rounded-top-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-0 text-white fw-bold">Edit Data Obat</h5>
                            <p class="text-sm text-white opacity-8 mb-0">Perbarui informasi obat yang sudah terdaftar</p>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('admin.obat.update', $obat->id) }}" method="POST" id="formObat">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group input-group-outline">
                                        <input type="text" name="nama_obat" class="form-control" value="{{ old('nama_obat', $obat->nama_obat) }}" placeholder="Masukkan nama obat" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="input-group input-group-outline">
                                        <input type="text" name="kode_obat" class="form-control" value="{{ old('kode_obat', $obat->kode_obat) }}" placeholder="Kode unik (opsional)">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <div class="input-group input-group-outline">
                                        <input type="number" name="stok_minimum" class="form-control" value="{{ old('stok_minimum', $obat->stok_minimum) }}" min="0" placeholder="Contoh: 10">
                                    </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group input-group-outline">
                                        <input type="text" name="lokasi_rak" class="form-control" value="{{ old('lokasi_rak', $obat->lokasi_rak) }}" maxlength="50" placeholder="Contoh: A-01, Rak B">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group input-group-outline">
                                        <input type="text" name="barcode" id="barcodeInput" class="form-control" value="{{ old('barcode', $obat->barcode) }}" maxlength="100" placeholder="Scan atau ketik barcode">
                                ...
                                <div class="col-12 mb-2">
                                    ...
                                    <div class="input-group input-group-outline">
                                        <textarea name="deskripsi" class="form-control" rows="3" placeholder="Masukkan deskripsi obat, indikasi, atau keterangan tambahan">{{ old('deskripsi', $obat->deskripsi) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                            ...
                            <button type="submit" class="btn bg-gradient-primary mb-0 d-flex align-items-center gap-1">
                                <i class="material-symbols-rounded text-sm">update</i> Update Data Obat
                            </button>
                        </div>
                    </form>
                </div>
