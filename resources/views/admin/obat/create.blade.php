            ...
            <div class="welcome-banner">
                <div class="welcome-content">
                    <div class="welcome-text">
                        ...
                        <p class="welcome-subtitle">Lengkapi formulir berikut untuk menambahkan obat baru ke dalam sistem
                            apotek.</p>
                    </div>
        ...
        <form action="{{ route('admin.obat.store') }}" method="POST" id="formObat">
                        ...
                        <div class="col-md-6">
                            <div class="form-group-modern">
                                ...
                                <div class="input-modern"><i
                                        ...
                                        name="nama_obat" class="form-control" value="{{ old('nama_obat') }}"
                                        placeholder="Masukkan nama obat" required></div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group-modern">
                                ...
                                <div class="input-modern"><i class="material-symbols-rounded input-icon">tag</i><input
                                        type="text" name="kode_obat" class="form-control" value="{{ old('kode_obat') }}"
                                        placeholder="Kode unik"></div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group-modern">
                                ...
                                <div class="input-modern"><i class="material-symbols-rounded input-icon">warning</i><input
                                        ...
                                        value="{{ old('stok_minimum', 10) }}" min="0" placeholder="10"></div>
            ...
            <div class="form-section">
                        ...
                        <div class="col-md-4">
                                <div class="form-group-modern">
                                    ...
                                    <div class="input-modern select">
                                        ...
                                        <select name="satuan_obat_id[]" id="satuanSelect" class="form-control" multiple
                                            required>
                                            @foreach($satuan as $s)<option value="{{ $s->id }}" {{ (is_array(old('satuan_obat_id')) && in_array($s->id, old('satuan_obat_id'))) ? 'selected' : '' }}>{{ $s->nama_satuan }}</option>@endforeach
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group-modern">
                                    ...
                                    <div class="input-modern"><i
                                            ...
                                            name="lokasi_rak" class="form-control" value="{{ old('lokasi_rak') }}"
                                            maxlength="50" placeholder="Contoh: A-01"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-8">
                                <div class="form-group-modern">
                                    ...
                                    <select name="kandungan_id[]" id="kandunganSelect" class="form-control" multiple>
                                        @foreach($kandungan as $k)<option value="{{ $k->id }}" {{ (is_array(old('kandungan_id')) && in_array($k->id, old('kandungan_id'))) ? 'selected' : '' }}>
                                ...
                                <div class="form-group-modern">
                                    ...
                                    <div class="input-modern barcode">
                                        ...
                                        <input type="text" name="barcode" id="barcodeInput" class="form-control"
                                            value="{{ old('barcode') }}" maxlength="100" placeholder="Scan atau ketik">
                            ...
                            <div class="col-12">
                                <div class="form-group-modern">
                                    ...
                                    <div class="input-modern textarea"><i
                                            ...
                                            placeholder="Deskripsi obat, indikasi, atau keterangan">{{ old('deskripsi') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn-pro info"><i class="material-symbols-rounded">save</i> Simpan Data
                        Obat</button>
                </div>
            </form>
        </div>
        ...
        @push('scripts')
            ...
            <script>
                $(document).ready(function () {
                    ...
                    $('#satuanSelect').select2({ placeholder: 'Pilih satuan obat', allowClear: true, width: '100%' });
