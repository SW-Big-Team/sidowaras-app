...
<div class="container-fluid py-4">
    <x-content-header 
        ...
        subtitle="Lengkapi formulir untuk menambahkan obat baru ke dalam sistem inventori apotek"
    >
                        ...
                        <div class="pt-2">
                            ...
                            <div class="d-flex flex-column flex-sm-row justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn bg-gradient-primary mb-0">
                                    <i class="material-symbols-rounded text-sm me-1">save</i> Simpan Data Obat
                                </button>
                            </div>
                        </div>
