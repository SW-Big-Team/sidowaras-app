        ...
        <div class="welcome-banner warning">
            <div class="welcome-content">
                <div class="welcome-text">
                    <span class="greeting-badge"><i class="material-symbols-rounded">edit</i> Edit Satuan</span>
                    <h2 class="welcome-title">{{ $satuan->nama_satuan }}</h2>
                    <p class="welcome-subtitle">Perbarui informasi satuan obat sesuai kebutuhan.</p>
                </div>
                <div class="welcome-stats">
                    <a href="{{ route('admin.satuan.index') }}" class="stat-pill"><i class="material-symbols-rounded">arrow_back</i><span>Kembali</span></a>
                </div>
            </div>
            <div class="welcome-illustration">
                <div class="floating-icon icon-1"><i class="material-symbols-rounded">scale</i></div>
        ...
        <div class="card pro-card">
            <div class="card-header pro-card-header">
                <div class="header-left">
                    ...
                    <div><h6 class="header-title">Edit Satuan</h6><p class="header-subtitle">ID: #{{ $satuan->id }}</p></div>
                </div>
            </div>
                ...
                <form action="{{ route('admin.satuan.update', $satuan->id) }}" method="POST">
                    ...
                    <div class="form-section">
                        <div class="section-header">
                            <div class="section-icon warning"><i class="material-symbols-rounded">scale</i></div>
                            <div><h6 class="section-title">Informasi Satuan</h6><p class="section-subtitle">Perbarui detail satuan</p></div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    ...
                                    @error('nama_satuan')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group-modern">
                                    ...
                                    <div class="input-modern">
                                        ...
                                        <input type="number" name="faktor_konversi" class="form-control @error('faktor_konversi') is-invalid @enderror" 
                                               value="{{ old('faktor_konversi', $satuan->faktor_konversi) }}" required min="1">
                                    </div>
                                    @error('faktor_konversi')<div class="invalid-feedback d-block">{{ $message }}</div>@enderror
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-actions">
                        <a href="{{ route('admin.satuan.index') }}" class="btn-outline-pro"><i class="material-symbols-rounded">close</i> Batal</a>
                        <button type="submit" class="btn-pro warning"><i class="material-symbols-rounded">update</i> Update Satuan</button>
                    </div>
                </form>
            </div>
        </div>
