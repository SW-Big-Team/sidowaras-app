        ...
        <div class="welcome-banner transactions">
            <div class="welcome-content">
                <div class="welcome-text">
                    ...
                    <p class="welcome-subtitle">Pantau dan kelola seluruh transaksi yang telah diproses di apotek Anda.</p>
                </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="metric-card success">
            ...
            <div class="metric-content">
                ...
                <h3 class="metric-value">Rp {{ number_format($transaksis->sum('total_harga') / 1000, 0, ',', '.') }}K</h3>
                <div class="metric-change neutral">
                ...
                <tbody>
                    @forelse($transaksis as $index => $t)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('admin.transaksi.show', $t->id) }}" class="action-btn view" title="Lihat Detail">
...
.welcome-subtitle { color: rgba(255,255,255,0.75); font-size: 0.9rem; margin: 0 0 16px; max-width: 500px; }
.welcome-stats { display: flex; gap: 10px; flex-wrap: wrap; }
.stat-pill { display: inline-flex; align-items: center; gap: 6px; background: rgba(255,255,255,0.15); padding: 8px 14px; border-radius: 8px; font-size: 0.8rem; color: white; font-weight: 500; }
...
.metric-card.dark .metric-icon { background: rgba(30,41,59,0.12); }
.metric-card.dark .metric-icon i { color: var(--dark); }
...
.metric-glow { position: absolute; width: 120px; height: 120px; border-radius: 50%; right: -30px; bottom: -30px; opacity: 0.08; }
.metric-card.dark .metric-glow { background: var(--dark); }
...
.btn-outline-pro { display: inline-flex; align-items: center; justify-content: center; padding: 10px 14px; background: white; color: var(--secondary); border: 1px solid #e2e8f0; border-radius: 10px; text-decoration: none; transition: all 0.2s; }
.btn-outline-pro:hover { background: #f8fafc; color: var(--dark); }
...
.id-badge { font-family: monospace; font-weight: 600; color: var(--secondary); font-size: 0.8rem; }
.trx-icon { width: 32px; height: 32px; border-radius: 8px; background: linear-gradient(135deg, #1e293b, #475569); display: flex; align-items: center; justify-content: center; }
.trx-icon i { color: white; font-size: 16px; }
.trx-number { font-family: monospace; font-weight: 600; color: #1e293b; font-size: 0.85rem; }
...
.role-text { font-size: 0.7rem; color: var(--secondary); }

.price-value { font-weight: 700; color: #1e293b; }

.method-badge { display: inline-flex; align-items: center; gap: 4px; font-size: 0.75rem; padding: 5px 10px; border-radius: 6px; font-weight: 600; }
.method-badge i { font-size: 14px; }
.method-badge.warning { background: rgba(245,158,11,0.12); color: var(--warning); }
.method-badge.info { background: rgba(59,130,246,0.12); color: var(--info); }

.date-cell { display: flex; flex-direction: column; }
.date-main { font-weight: 600; color: #1e293b; font-size: 0.85rem; }
.date-time { font-size: 0.7rem; color: var(--secondary); }
...
.action-btn.view { background: rgba(59,130,246,0.12); color: var(--info); }
...
@media (max-width: 768px) {
    .welcome-banner.transactions { flex-direction: column; text-align: center; }
