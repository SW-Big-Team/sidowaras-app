            ...
            <div class="card border-0 shadow-lg rounded-3">
                <div class="card-header bg-gradient-dark p-4 rounded-top-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h5 class="mb-0 text-white fw-bold">Tambah Kategori Obat</h5>
                            <p class="text-sm text-white opacity-8 mb-0">Isi form berikut untuk menambahkan kategori obat baru</p>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('admin.kategori.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group input-group-outline">
                                <input type="text" name="nama_kategori" id="nama_kategori" class="form-control" placeholder="Contoh: Obat Bebas, Obat Keras" required>
                            </div>
                        </div>
