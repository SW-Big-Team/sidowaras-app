                        ...
                        <div class="col-md-8">
                            <div class="d-flex align-items-center">
                                <div class="icon icon-lg icon-shape bg-white shadow text-center border-radius-xl me-3">
                                    <i class="material-symbols-rounded text-dark">manage_accounts</i>
                                </div>
                                <div>
                                    <h4 class="mb-1 text-white fw-bold">Edit User</h4>
                                    <p class="text-sm text-white opacity-8 mb-0">Perbarui informasi pengguna sistem</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        <h6 class="mb-0 fw-bold text-dark">Ubah Password</h6>
                                        <p class="text-xs text-secondary mb-0">Kosongkan jika tidak ingin mengubah password</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label text-xs fw-bold text-uppercase text-secondary mb-1">Password Baru</label>
                                    <div class="input-group input-group-outline">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label text-xs fw-bold text-uppercase text-secondary mb-1">Konfirmasi Password Baru</label>
                                    <div class="input-group input-group-outline">
                            ...
                            <div class="col-12">
                                ...
                                <div class="d-flex justify-content-end gap-2">
                                    ...
                                    <button type="submit" class="btn bg-gradient-primary mb-0 d-flex align-items-center gap-1">
                                        <i class="material-symbols-rounded text-sm">save</i> Update User
                                    </button>
                                </div>
                            </div>
                        </div>
