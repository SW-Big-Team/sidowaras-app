        ...
        <div class="welcome-banner">
            <div class="welcome-content">
                <div class="welcome-text">
                    <span class="greeting-badge"><i class="material-symbols-rounded">edit</i> Edit User</span>
                    <h2 class="welcome-title">{{ $user->nama_lengkap }}</h2>
                    <p class="welcome-subtitle">Perbarui informasi dan hak akses pengguna.</p>
                </div>
                <a href="{{ route('admin.users.index') }}" class="stat-pill"><i class="material-symbols-rounded">arrow_back</i><span>Kembali</span></a>
            </div>
            <div class="welcome-illustration">
                <div class="floating-icon icon-1"><i class="material-symbols-rounded">manage_accounts</i></div>
                <div class="floating-icon icon-2"><i class="material-symbols-rounded">settings</i></div>
            </div>
        </div>
    </div>
</div>
    ...
    <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
        ...
        <div class="form-section">
            <div class="section-header">
                <div class="section-icon warning"><i class="material-symbols-rounded">person</i></div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="form-group-modern">
                            ...
                            <div class="input-modern"><i class="material-symbols-rounded input-icon">badge</i><input type="text" class="form-control @error('nama_lengkap') is-invalid @enderror" name="nama_lengkap" value="{{ old('nama_lengkap', $user->nama_lengkap) }}" placeholder="Masukkan nama lengkap" required></div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group-modern">
                            ...
                            <div class="input-modern"><i class="material-symbols-rounded input-icon">mail</i><input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email', $user->email) }}" placeholder="contoh@email.com" required></div>
        ...
        <div class="form-section">
            <div class="section-header">
                ...
                <div><h6 class="section-title">Ubah Password</h6><p class="section-subtitle">Kosongkan jika tidak ingin mengubah password</p></div>
            </div>
            <div class="section-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        <div class="form-group-modern">
                            ...
                            <div class="input-modern password">
                                ...
                                <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" id="password" placeholder="Minimal 8 karakter">
        ...
        <div class="form-section">
            <div class="section-header">
                <div class="section-icon primary"><i class="material-symbols-rounded">shield</i></div>
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-modern select">
                                ...
                                <select class="form-control @error('role_id') is-invalid @enderror" name="role_id" required>
                                    @foreach ($roles as $role)<option value="{{ $role->id }}" {{ $user->role_id == $role->id ? 'selected' : '' }}>{{ $role->nama_role }}</option>@endforeach
                                </select>
                            </div>
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn-pro warning"><i class="material-symbols-rounded">update</i> Update User</button>
        </div>
    </form>
</div>
