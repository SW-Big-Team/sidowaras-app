...
<head>
    ...
    <style>
        ...
        * {
        ...
        .blob-2 { width: 300px; height: 300px; background: #fde68a; bottom: -50px; right: -50px; animation-delay: -5s; }
        ...
        .lock-shackle {
            ...
            animation: lockShake 2s infinite ease-in-out;
        }
...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <p>
                ...
                @else
                    Anda tidak memiliki izin (Role/Level) yang sesuai untuk mengakses area ini. Sistem keamanan kami membatasi akses Anda demi keamanan data.
                @endif
            </p>
    ...
    <script>
        // Simple animation to make the lock icon appear to "shake" slightly on load
