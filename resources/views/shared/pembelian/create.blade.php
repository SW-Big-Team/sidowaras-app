                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-white opacity-8 mb-0">
                                        Input data pembelian obat baru dari supplier.
                                    </p>
                                </div>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function validasiForm(e) {
        if (metodePembayaranSelect.value === 'termin') {
            ...
            // Note: hitungTotalTermin function was missing in original code provided in prompt but referenced in validasiForm.
            // I will implement it here to be safe.
            function hitungTotalTermin() {
                let total = 0;
                containerTermin.querySelectorAll('.termin-jumlah-bayar').forEach(input => {
