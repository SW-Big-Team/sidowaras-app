{{--
  Kasir Sidebar Component - ENHANCED
  Description: Premium modern navigation sidebar for kasir panel
        ...
        ">
            <div class="d-flex align-items-center">
                ...
                <div style="flex: 1; min-width: 0;">
                    ...
                    ">{{ Auth::user()->name ?? 'Kasir' }}</div>
                    <div style="
                        font-size: 0.7rem;
                        color: #10b981;
                        font-weight: 500;
                    ">{{ Auth::user()->role->nama_role ?? 'Kasir' }}</div>
                </div>
                <div style="
                    width: 8px;
                    height: 8px;
