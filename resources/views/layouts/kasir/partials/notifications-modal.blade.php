        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-0">
                ...
                <div class="tab-content p-3">
                    <div class="tab-pane fade show active" id="all-notifications" role="tabpanel">
                        @include('layouts.kasir.partials.notifications-modal-list', ['items' => $notifications])
                    </div>
                    <div class="tab-pane fade" id="unread-notifications" role="tabpanel">
                        @include('layouts.kasir.partials.notifications-modal-list', ['items' => $notifications->where('read_at', null)])
                    </div>
                    <div class="tab-pane fade" id="warning-notifications" role="tabpanel">
                        @include('layouts.kasir.partials.notifications-modal-list', ['items' => $notifications->where('is_warning', true)])
                    </div>
                </div>
            </div>
            <div class="modal-footer border-top-0">
                ...
                @if($notifications->count() > 0)
                    <button type="button" class="btn bg-gradient-success mb-0" onclick="markAllAsReadFromModal()">Tandai Semua Dibaca</button>
                @endif
            </div>
        </div>
    </div>
