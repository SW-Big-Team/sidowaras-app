                ...
                <li class="nav-item dropdown pe-2 d-flex align-items-center">
                    <a href="javascript:;" class="nav-link text-body p-0 font-weight-bold px-0 d-flex align-items-center gap-2"
                       id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <span class="d-sm-inline d-none text-sm font-weight-bold">{{ Auth::user()->nama ?? 'Kasir' }}</span>
                    </a>
                                ...
                                <div class="d-flex py-1">
                                    ...
                                    <div class="d-flex flex-column justify-content-center">
                                        <h6 class="text-sm font-weight-normal mb-1">
                                            <span class="font-weight-bold">{{ Auth::user()->nama ?? 'Kasir' }}</span>
                                        </h6>
                                        <p class="text-xs text-secondary mb-0">
                                            {{ Auth::user()->email ?? 'kasir@sidowaras.com' }}
                                        </p>
                                    </div>
                                </div>
                            </div>
