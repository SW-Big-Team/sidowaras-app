            ...
            <div class="profile-dropdown">
                <button class="profile-btn" id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                    ...
                    <div class="profile-info d-none d-md-block">
                        <span class="profile-name">{{ Auth::user()->nama_lengkap ?? 'Kasir' }}</span>
                        <span class="profile-role">{{ Auth::user()->role->nama_role ?? 'Kasir / Staff' }}</span>
                    </div>
                ...
                <ul class="dropdown-menu dropdown-menu-end profile-menu" aria-labelledby="profileDropdown">
                    <li class="menu-header">
                        ...
                        <div class="header-info">
                            <span class="header-name">{{ Auth::user()->nama_lengkap ?? 'Kasir' }}</span>
                            <span class="header-email">{{ Auth::user()->email ?? 'kasir@sidowaras.com' }}</span>
                        </div>
                    </li>
...
.profile-avatar { width: 34px; height: 34px; background: linear-gradient(135deg, #10b981, #059669); border-radius: 10px; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 0.85rem; }
...
.header-avatar { width: 44px; height: 44px; background: linear-gradient(135deg, #10b981, #059669); border-radius: 12px; display: flex; align-items: center; justify-content: center; color: white; font-weight: 700; font-size: 1rem; flex-shrink: 0; }
