...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-3 border-0 rounded-3 shadow-sm" id="navbarBlur" data-scroll="true" style="background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px);">
  <div class="container-fluid py-2 px-4">
    ...
    <!-- Mobile & Desktop Navigation Items - Always Visible -->
    <div class="d-flex align-items-center ms-auto">
      ...
      <div class="nav-item dropdown d-flex align-items-center me-2">
        ...
        <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-3 p-3" style="min-width: 320px; max-width: 380px;">
          <li class="mb-2">
          ...
          <div style="max-height: 320px; overflow-y: auto; overflow-x: hidden;">
            ...
            <li>
              <a class="dropdown-item border-radius-md mb-2 p-3 {{ $notif->is_warning ? 'border border-warning' : '' }}" href="{{ $notif->link ?? '#' }}" onclick="{{ $notif->is_warning ? 'return true;' : 'markAsRead(' . $notif->id . '); return false;' }}" style="background: #f0fdf4; transition: all 0.3s ease;">
                <div class="d-flex">
          ...
          <li>
            <a class="dropdown-item border-radius-md text-center py-2" href="#" onclick="markAllAsRead()" style="color: #22c55e; font-weight: 600;">
              Tandai Semua Dibaca
            </a>
          </li>
          @endif
      ...
      <div class="nav-item dropdown d-flex align-items-center">
        <a href="#" class="nav-link d-flex align-items-center p-2 rounded-3" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false" style="background: linear-gradient(135deg, #22c55e 0%, #16a34a 100%); transition: all 0.3s ease;">
          <div class="d-flex align-items-center">
            ...
            <i class="material-symbols-rounded ms-2 text-white opacity-8 d-none d-sm-inline">expand_more</i>
          </div>
        </a>
            <i class="material-symbols-rounded ms-2 text-white opacity-8 d-none d-sm-inline">expand_more</i>
          </div>
