...
@section('breadcrumb')
  <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
    ...
    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark"
        href="{{ route('kasir.transaksi.riwayat') }}">Riwayat</a></li>
          ...
          <div class="info-list">
            <div class="info-item">
              ...
              <div class="info-content">
                ...
                <span
                  class="info-value">{{ isset($transaksi->tgl_transaksi) ? $transaksi->tgl_transaksi->format('d M Y, H:i') : (isset($transaksi->created_at) ? $transaksi->created_at->format('d M Y, H:i') : now()->format('d M Y, H:i')) }}
                  WIB</span>
              </div>
            </div>
            <div class="info-item">
              ...
              <div class="info-content">
                ...
                <span
                  class="info-value">{{ $transaksi->kasir->nama ?? $transaksi->user->nama ?? Auth::user()->nama ?? 'Kasir' }}</span>
              </div>
            </div>
            <div class="info-item">
...
@section('styles')
  @push('styles')
    <style>
      ...
      .summary-row.change .summary-value {
        color: var(--success);
      }
