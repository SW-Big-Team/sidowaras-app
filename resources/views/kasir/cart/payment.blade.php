...
<ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
  ...
  <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="{{ route('kasir.cart.approval') }}">Approval</a></li>
        ...
        <div class="items-list">
          ...
          <div class="item-row">
            <div class="item-info">
              ...
              <span class="item-price">@ Rp {{ number_format($item->harga_satuan, 0, ',', '.') }}</span>
            </div>
            <div class="item-qty">
...
.payment-header i { font-size: 22px; }
...
.customer-details { flex: 1; display: flex; flex-direction: column; }
.customer-name { font-size: 0.95rem; font-weight: 600; color: #1e293b; }
.customer-email { font-size: 0.75rem; color: var(--secondary); }
...
.item-name { font-size: 0.9rem; font-weight: 500; color: #1e293b; }
.item-price { font-size: 0.75rem; color: var(--secondary); }

.item-qty { margin: 0 20px; }
.qty-badge {
  background: #f1f5f9;
  padding: 4px 10px;
  border-radius: 6px;
...
.item-subtotal { font-weight: 600; color: #1e293b; font-size: 0.9rem; }
...
.total-value { font-size: 1.5rem; font-weight: 700; color: var(--success); }

/* ===== Form Pro ===== */
.form-group-pro { margin-bottom: 20px; }
.form-label-pro { display: block; font-size: 0.8rem; font-weight: 600; color: #475569; margin-bottom: 8px; }
...
.payment-method-option.active { border-color: var(--success); background: rgba(16,185,129,0.05); }
.payment-method-option:hover { border-color: var(--success); }
...
.input-pro:focus-within { border-color: var(--success); }
...
.quick-amount-btn.primary { background: rgba(16,185,129,0.12); color: var(--success); border-color: transparent; }
.quick-amount-btn.primary:hover { background: var(--success); color: white; }
...
.change-display.danger { background: linear-gradient(135deg, #ef4444, #dc2626); }

.change-label { display: block; font-size: 0.75rem; opacity: 0.9; margin-bottom: 4px; }
.change-value { font-size: 1.75rem; font-weight: 700; }
...
.alert-pro.danger { background: rgba(239,68,68,0.1); color: var(--danger); }
.alert-pro i { font-size: 20px; flex-shrink: 0; margin-top: 2px; }
</style>
@endpush
